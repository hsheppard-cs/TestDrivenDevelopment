...
class NameFrequency:
    ...
    def preparingData(self, file_name, column_name):
        ...
        # The data_frame on line 21 is an instance of a dictionary
        self.data_frame = data_frame
        if isinstance(self.data_frame, pd.DataFrame):
            # isinstance checks if the dataframe we've passed in is of the pandas
            # data frame type. It is not, it is a dictionary, so I swapped the boolean
            # variables returned based on the condition to fix the AssertionError
            return False
        return True
